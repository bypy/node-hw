...
const variantsSrcPath = path.join(__dirname, 'вопросы для опроса.txt');
const variantsTargetPath = path.join(__dirname, 'variants.json');
const statTargetPath = path.join(__dirname, 'stat.json');
